...
<body>
  ...
  <div class="content">
   <div class="welcome">
        ...
        <a href="add_admin.php"><button name="add_admin" class="add_btn">Add Admin</button></a>
        <hr>
    </div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class ="view_btn" href="../delete_admin_info.php?id=<?php echo $row['id']; ?>"><i class="fas fa-trash-alt"> Delete </i></a>
            </td>
          </tr>
        </tbody>
        <?php } ?>
