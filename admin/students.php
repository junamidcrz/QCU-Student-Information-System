...
<body>
  ...
  <div class="content">
   <div class="welcome">
        ...
        <a href="add_student.php"><button name="add_student" class="add_btn">Add Student</button></a>
        <hr>
    </div>
    ...
    <div class="tables">
      <center>
      <div class="schedule">
        <?php include ('..\student_list_sql.php');?>
      <table>
        <thead>
          <tr>
            <td>No.</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class ="view_btn" href="view_student_info.php?id=<?php echo $row['id']; ?>"><i class="far fa-eye"> View</i></a></td>
          </tr>
        </tbody>
        <?php } ?>
      </table> 
