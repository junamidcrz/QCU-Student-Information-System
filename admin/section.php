...
<body>
  ...
  <div class="content">
   <div class="welcome">
        ...
        <a href="add_section.php"><button name="add_section" class="add_btn">Add Section</button></a>
        <hr>
    </div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class ="view_btn" href="view_section_info.php?id=<?php echo $row['id']; ?>"><i class="far fa-eye"> View</i></a></td>
          </tr>
        </tbody>
        <?php } ?>
      </table> 
