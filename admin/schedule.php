...
<body>
  ...
  <div class="content">
   <div class="welcome">
        ...
        <a href="add_schedule.php"><button name="add_schedule" class="add_btn">Add Schedule</button></a>
        <hr>
    </div>
    ...
    <div class="tables">
      <center>
      <div class="schedule">
        <?php include ('..\schedule_list_sql.php');?>
      <table>
        <thead>
          <tr>
            <td>No.</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class ="view_btn" href="view_schedule_info.php?id=<?php echo $row['schedule_id']; ?>"><i class="far fa-eye"> View</i></a></td>
          </tr>
        </tbody>
        <?php } ?>
      </table> 
