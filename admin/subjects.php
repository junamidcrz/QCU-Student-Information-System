...
<body>
  ...
  <div class="content">
   <div class="welcome">
        ...
        <a href="add_subject.php"><button name="add_student" class="add_btn">Add Subject</button></a>
        <hr>
    </div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class ="view_btn" href="view_subject_info.php?id=<?php echo $row['id']; ?>"><i class="far fa-eye"> View</i></a></td>
          </tr>
        </tbody>
        <?php } ?>
      </table> 
